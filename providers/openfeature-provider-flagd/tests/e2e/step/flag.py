...
from .handler import assert_handlers
...
def assert_flag_change_event(
    ...
    assert_handlers(event_handles, ProviderEvent.PROVIDER_CONFIGURATION_CHANGED, 10)
    ...
    for event in event_handles:
        if event["type"] == ProviderEvent.PROVIDER_CONFIGURATION_CHANGED:
